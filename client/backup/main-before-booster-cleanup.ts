...
class MazeHunter extends Phaser.Scene {
  ...
  private drawBoosterBar() {
    ...
    const boosters = [
      { icon: "+5", label: "+5", color: 0xffd9ef },
      { icon: "POWER", label: "POWER", color: 0xd9f8ff },
      { icon: "HINT", label: "HINT", color: 0xfff1c7 },
    ];
  ...
  private addSpecialVisual(
    ...
    if (special === "line-h") {
      ...
      const sparkle = this.add.text(0, 0, "✦", {
        fontFamily: "Arial Black, Arial, sans-serif",
  ...
  private showIntroScreen() {
    ...
    const boosters = [
      ["POWER", "POWER"], ["SPECIAL", "SPECIAL"], ["+5", "BOOST"],
    ];
