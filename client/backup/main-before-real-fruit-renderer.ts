...
const CANDIES: Array<{
  ...
  { color: 0xff4f73, dark: 0x9c2347, glow: 0xffa1b6, asset: "fruit-strawberry" },
  { color: 0xff9a2f, dark: 0xb84c12, glow: 0xffd18a, asset: "fruit-orange" },
  { color: 0x7041c8, dark: 0x44268f, glow: 0xb38cff, asset: "fruit-grapes" },
  { color: 0x4f9cff, dark: 0x245ba5, glow: 0xa5d4ff, asset: "fruit-blueberry" },
  { color: 0xff4b62, dark: 0xb51f39, glow: 0xffa2ad, asset: "fruit-watermelon" },
  { color: 0xffd34b, dark: 0xa8730d, glow: 0xffef91, asset: "fruit-pineapple" },
];
...
class MazeHunter extends Phaser.Scene {
  ...
  private drawCandy(
    ...
    const icon = this.add
      .image(0, 0, data.asset)
      .setOrigin(0.5)
      .setDisplaySize(r * 1.62, r * 1.62);
